...
deckList.append(Monstre("Flipper",900,1400,3,"Bete","Choisie un monstre de votre main et l'invoque si c'est possible","CHOOSE hand SUMMON cible"))
deckList.append(Monstre("Colibri",800,1000,3,"Bete","Choisi un monstre que vous controlez, vous vous soignez de 200 x son niveau", "CHOOSE allie  SOIN* 200 allie.niveau"))
...
deckList.append(Monstre("Chevalier Néos",2700,2300,7,"Guerrier","Choisi un monstre ennemie, divise son ATK par 2","CHOOSE ennemie DIVIDE ennemie.ATK 2"))
...
deckList.append(Magie("Dernier espoir","Détruit tous vos monstres et infliger 400 point de dégat à votre adversaire par monstre détruit","DESTROY bord DAMAGE* nb 400"))
